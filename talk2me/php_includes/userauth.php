...
if (isset($_POST["formChoice"]) && $_POST["formChoice"] == "signup"){  //check if the form to handle is a 
...
if (isset($_POST['formChoice']) && $_POST['formChoice'] == "login"){	//check if the form to handle is a 
																				//register or login form. true = reg
	$loginStarted = True;	
